...
public class ModernPlace {
    ...
    /**
     * Create a new ModernPlace object for a hotel/hostel that does not have an image resource
     *
    ...
    /**
     * Create a ModernPlace object.
     *
     * @param mPlaceName    is the place name
     * @param mPlaceRating  is the place Double value of rating
     * @param mPlaceAddress is the place address
     * @param mPhone        is the place phone number
     */
    ...
    /**
     * @param mPlaceName    is the place name
     * @param mPlaceType    is the place type (shopping mall, electronics shop ..etc)
     * @param mPlaceRating  is the place Double value of rating
     * @param mPlaceAddress is the place address
     * @param mPhone        is the place phone number
     */
